...
const landmarks = [
  ...
  { km: 150, label: "Electrified sky", detail: "By this height the ionosphere is well developed: atoms are ionized by sunlight, creating charged layers that affect radio signals and space weather" },
...
function getBoundaryLabelGap(layerName, compact, phone) {
  return 24 + getLayerLabelOffset(layerName, compact, phone);
}
